...
def verificaJogadaValida(tabuleiro, pos1, pos2, jogador_turno, humano, agente, timeA, timeB):
  ...
  if(peca.__contains__("0")):
    ...
    return Peao.verificacaoJogadaPeao(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("2")):
    return Lanca.verificacaoJogadaLanca(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("3")):
    return Cavaleiro.verificacaoJogadaCavaleiro(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("4")):
    return General_Prateado.verificacaoJogadaPrata(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("5")):
    return General_Dourado.verificacaoJogadaOuro(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("6")):
    return Bispo.verificacaoJogadaBispo(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("7")):
    return Torre.verificacaoJogadaTorre(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
  elif(peca.__contains__("8")):
    return Rei.verificacaoJogadaRei(tabuleiro, pos1, pos2, jogador_turno, humano, agente, peca)
